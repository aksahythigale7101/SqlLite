...
CRUD_Operation.InsertData ('Rahul Sharma', 21, 'rahul@example.com', 'Computer Science');
CRUD_Operation.InsertData('Priya Deshmukh', 22, 'priya.d@example.com', 'Data Science');
CRUD_Operation.InsertData('Aman Verma', 20, 'aman.verma@example.com', 'Computer Science');
CRUD_Operation.InsertData('Sneha Kulkarni', 23, 'sneha.k@example.com', 'Information Technology');
CRUD_Operation.InsertData('Rohan Patil', 21, 'rohan.patil@example.com', 'Electronics');
CRUD_Operation.InsertData('Ananya Joshi', 22, 'ananya.j@example.com', 'Computer Science');
"""
...
# keys.delete_row("DEPARTMENT","DepartmentId",6)# not delete beacuse the Id 1 refreance presetn in employee table
...
WinFunction.Rank()
WinFunction.DenseRank()
WinFunction.Lag()
WinFunction.Lead()
WinFunction.Percent_Rank()
WinFunction.First_LAST_Value()